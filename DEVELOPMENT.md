# DRP — Architecture & Developer Guide

Architecture, tech stack, local development, API reference, testing, and
production (Docker / UDS / Kubernetes) deployment for the Deployment Readiness
Platform. For the project overview, live demo, and screenshots, see
[README.md](README.md).
