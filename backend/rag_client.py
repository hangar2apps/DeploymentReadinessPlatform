...
def ask_policy(
    ...
    with grpc.insecure_channel(config.RAG_GRPC_TARGET) as channel:
        ...
        # QueryRequest is dynamically generated by protobuf at runtime; type checkers can't statically analyze this.
        request = docintel_pb2.QueryRequest(question=question, max_chunks=max_chunks)  # type: ignore[attr-defined]
